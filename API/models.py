...
class Dog(models.Model):
    ...
    behavior = models.TextField(default='Brak zachowań')
    prohibitions = models.TextField(default='Brak zakazów')
    recommendations = models.TextField(default='Brak zaleceń')
